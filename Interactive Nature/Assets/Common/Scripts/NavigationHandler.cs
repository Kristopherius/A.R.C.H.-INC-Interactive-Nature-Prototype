...
public class NavigationHandler : MonoBehaviour
{
    ...
    public string m_ForwardButtonNavigation = "[Name of Scene To Load]";
    ...
    {
        Debug.Log("HandleForwardButtonPressed() called.");
        if (SceneManager.GetActiveScene().name != m_ForwardButtonNavigation)
            LoadScene(m_ForwardButtonNavigation);
    }
